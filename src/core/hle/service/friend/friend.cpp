...
public:
    explicit IFriendService(Core::System& system_) : ServiceFramework{system_, "IFriendService"} {
        ...
        static const FunctionInfo functions[] = {
            ...
            {10420, &IFriendService::Unknown10420, "Unknown10420"},
        ...
        event = Kernel::KEvent::Create(kernel, "friend:GetProfileList");
        event->Initialize();
    }
...
private:
    ...
    void Unknown10420(Kernel::HLERequestContext& ctx) {
