...
void QtSoftwareKeyboard::SubmitNormalText(Service::AM::Applets::SwkbdResult result,
    ...
    submit_normal_callback(result, SanitizeText(std::move(submitted_text)));
}
...
void QtSoftwareKeyboard::SubmitInlineText(Service::AM::Applets::SwkbdReplyType reply_type,
    ...
    submit_inline_callback(reply_type, SanitizeText(std::move(submitted_text)), cursor_position);
}

std::u16string QtSoftwareKeyboard::SanitizeText(std::u16string in) const {
    return in;
}
