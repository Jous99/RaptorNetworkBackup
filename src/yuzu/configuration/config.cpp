...
void Config::ReadRendererValues() {
    ...
    ReadSettingGlobal(Settings::values.renderer_backend, QStringLiteral("backend"), 1);
...
void Config::ReadNetworkValues() {
    qt_config->beginGroup(QStringLiteral("Network"));
    Settings::values.raptor_token =
        ReadSetting(QStringLiteral("raptor_token"), QStringLiteral("")).toString().toStdString();
    qt_config->endGroup();
}
...
void Config::SaveRendererValues() {
    ...
    WriteSettingGlobal(QStringLiteral("backend"),
                       ...
                       Settings::values.renderer_backend.UsingGlobal(), 1);
...
void Config::SaveNetworkValues() {
    qt_config->beginGroup(QStringLiteral("Network"));
    WriteSetting(QStringLiteral("raptor_token"),
                 QString::fromStdString(Settings::values.raptor_token), QStringLiteral(""));
    qt_config->endGroup();
}
